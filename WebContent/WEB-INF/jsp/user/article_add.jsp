...
<body>
	<div id="wrap">
		...
		<div class="content">
			...
			<div class="form">
				<form action="articleAction_add.action" method="post">
					<div class="form_title">
						标题:&nbsp;&nbsp;<input name="article.title" type="text" size="60" maxlength="22" placeholder="博客标题22字以内" style="line-height: 2">
					</div>
					<div class="form_type">
						类型:&nbsp;&nbsp;<select name="article.articleTypeName">
											<c:forEach items="${articleTypelist}" var="a">
												<option>${a.getArticleTypeName()}</option>
											</c:forEach>
										</select>
					</div>					
					<div class="form_cont">
						内容:
						<textarea  maxlength="10000" name="article.content"  id="editor"   style="width: 900px; height: 280px;"></textarea>
             			<!-- <script id="editor" type="text/plain" style="width: 900px; height: 280px;"></script> -->
					</div>					
					<div class="button">
						<input type="button" value="保存"> <input type="submit"
							value="发表">
					</div>
