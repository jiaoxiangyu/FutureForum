			...
			<div class="left">
				...
				<div class="info">
					<ul>
						<li><h4>
								<a
									href="consumerAction_seekMyInfo.action?userId=${consumer.getUserId()}">${consumer.getUsername()}</a>
							</h4></li>
			...
			<div class="right">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<div class="pageseek">
							<form
								action="articleAction_pageSeekMyArticle.action?page=0&userId=${consumer.getUserId()}"
								method="post">
								<table>
									<tr>
										<td><a
											href="articleAction_pageSeekMyArticle.action?page=1">首页</a></td>
										<td><a
											href="articleAction_pageSeekMyArticle.action?page=${pageArgs.getPrePage()}">上一页</a></td>
										<td>${pageArgs.getPageNum()}/${pageArgs.getMaxPage()}</td>
										<td><a
											href="articleAction_pageSeekMyArticle.action?page=${pageArgs.getNextPage()}">下一页</a></td>
										<td><a
											href="articleAction_pageSeekMyArticle.action?page=${pageArgs.getMaxPage()}">尾页</a></td>
